...
public class ZichtRekeningTest {
	...
	public void setMaxKredietOnderNul_WaardeBoven0_werptException() {
		Assertions.assertThrows(IllegalArgumentException.class,
				() -> zrek2.setMaxKredietOnderNul(0. + Double.MIN_VALUE));
	}

	@Test
	public void setMaxKredietOnderNul_WaardeOnder0OnderSaldo_werptException() {
		zrek2.haalAf(800);
		Assertions.assertThrows(IllegalArgumentException.class, () -> zrek2.setMaxKredietOnderNul(-500));
	}
	...
	public void haalAf_ongeldigBedrag_saldoBlijftGelijk() {
		Assertions.assertFalse(zrek1.haalAf(-300));
		Assertions.assertEquals(0.0, zrek1.getSaldo());
	}
	...
	@Test
	public void haalAf_genoegSaldoOpRekening_saldoWijzigt() {
		// zrek1 heeft maxKrediet van -500
		zrek1.stortOp(1000);
		zrek1.haalAf(600);
		Assertions.assertEquals(400, zrek1.getSaldo());
	}
