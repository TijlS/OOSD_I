...
public class VerplaatsingPerBusTramTest {
    ...
    public void maakVerplaatsingPerBusTram_alleAttributenViaParameters_maaktObject() 
    {
        ...
        Assertions.assertEquals(4.2, vpbt1.getAantalKm());
    ...
    @Test
    public void setLijnnr_waardePositiefGrens_attribuutKrijgtWaarde() 
    {
        vpbt2.setLijnnr(1);
        Assertions.assertEquals(1, vpbt2.getLijnnr());
    }
    ...
    @Test
    public void setLijnnr_waardeNegatiefGrens_werptException() 
    {
    	Assertions.assertThrows(IllegalArgumentException.class, () -> vpbt2.setLijnnr(-1));
    }
