...
public class StartUp {
	...
	public void start() {
		...
		System.out.printf("%d keer aan de hendel draaien van een %s met %d ballen%n", aantalKeer,
				k1.getClass().getSimpleName().toLowerCase(), k1.getAantalItems());
		draaiNKeer(k1, aantalKeer, true);

		// 10 keer Grijpkraan
		GrijpKraan g1 = new GrijpKraan(20);
		System.out.printf("%d keer aan de hendel draaien van een %s met %d ballen%n", aantalKeer,
				g1.getClass().getSimpleName().toLowerCase(), g1.getAantalItems());
