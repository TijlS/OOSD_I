...
public class VoorwerpTest 
{
    ...
    @Test                       
    public void maakVoorwerp_naamSpatiesTekst_werptException() 
    {
    	Assertions.assertThrows(IllegalArgumentException.class, () -> new Voorwerp("    ", 5.0, 3));
    }
    @Test
    ...
    @Test
    public void maakVoorwerp_gewichtMaxRandGeval_werptException() 
    {
    	Assertions.assertThrows(IllegalArgumentException.class, () -> new Voorwerp("speer", 1000.0, 3));
    }

    @Test
    public void maakVoorwerp_gewichtMinRandGeval_werptException() 
    {
    	double kleinsteNegWaardeDichtbijNul = -Double.MIN_VALUE; 
    	Assertions.assertThrows(IllegalArgumentException.class, () -> new Voorwerp("speer", kleinsteNegWaardeDichtbijNul, 3));
    }
    
    @Test
    public void maakVoorwerp_gewichtMinRandGeval_maaktVoorwerp() 
    {
    	vwp2 = new Voorwerp("speer", 0, 3);
    	Assertions.assertEquals(0, vwp2.getGewicht());
    }
